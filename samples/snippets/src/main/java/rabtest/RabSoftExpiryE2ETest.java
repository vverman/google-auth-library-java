...
public class RabSoftExpiryE2ETest {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String encodedLocations = (String) rabClass.getMethod("getEncodedLocations").invoke(currentRab);
    List<String> locations = (List<String>) rabClass.getMethod("getLocations").invoke(currentRab);
    ...
    Constructor<?> rabConstructor = rabClass.getDeclaredConstructor(String.class, List.class, long.class);
    rabConstructor.setAccessible(true);
    Object manipulatedRab = rabConstructor.newInstance(encodedLocations, locations, newRefreshTime);
    ...
    String refreshedEncodedLocations = (String) rabClass.getMethod("getEncodedLocations").invoke(refreshedRab);
